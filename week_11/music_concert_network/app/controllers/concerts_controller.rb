class ConcertsController < ApplicationController
	...
	def index
		...
		@concerts_month = Concert.where(date: Date.tomorrow.beginning_of_day..Date.today.end_of_month)
	end
	...
	def popular
		@concerts = Concert.order(comments_count: :desc).where("comments_count > ?", 0)
		@popular_concerts = @concerts.limit(10)
